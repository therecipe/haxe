...
import (
	...
	_ "github.com/therecipe/qt/interop/haxe"

	"github.com/therecipe/qt/core"
	"github.com/therecipe/qt/qml"
	"github.com/therecipe/qt/quick"
	_ "github.com/therecipe/qt/quickcontrols2" //used from haxe
...
func main() {
	...
	callDart := widgets.NewQPushButton2("Go calls Haxe", nil)
	callDart.ConnectClicked(func(bool) {
		interopEngine.GlobalObject().Property("haxeFunction").Call([]*interop.PseudoQJSValue{interopEngine.NewGoType("Hello from Go")})
	})
	...
	interopEngine.GlobalObject().SetProperty("goSetupFunction", interopEngine.NewGoType(func() {
		...
		hw := widgets.NewQWidgetFromPointer(unsafe.Pointer(uintptr(interopEngine.GlobalObject().Property("haxeWidget").CallMethod("Pointer", nil).ToULongLong(nil))))
